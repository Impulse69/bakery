...
const MENU_ITEMS: MenuItem[] = [
  ...
  { path: '/products', label: 'Inventory Stock', permission: 'products:view', icon: <IconProducts /> },
  { path: '/inventory', label: 'Product List', permission: 'inventory:view', icon: <IconBox /> },
